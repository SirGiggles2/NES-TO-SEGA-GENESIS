...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_chr_buffer_dump.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_chr_buffer_dump.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\chr_buffer_dump_$BaseName.txt"
