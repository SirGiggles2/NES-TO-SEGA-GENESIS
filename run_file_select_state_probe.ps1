...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_file_select_state_probe.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_file_select_state_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\file_select_state_probe_$BaseName.txt"
