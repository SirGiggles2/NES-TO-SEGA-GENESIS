...
from restore_bank02_title_tables import restore_labels
...
VARIANTS = [
    {"name": "control", "labels": []},
    {"name": "text_palette", "labels": [TEXT_PTRS, PALETTE]},
    {"name": "spr_text", "labels": [SPR_DATA, TEXT_PTRS]},
    {"name": "spr_palette", "labels": [SPR_DATA, PALETTE]},
    {"name": "spr_text_palette", "labels": [SPR_DATA, TEXT_PTRS, PALETTE]},
]
