...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_file_select_nav_probe.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_file_select_nav_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\file_select_nav_probe_$BaseName.txt"
