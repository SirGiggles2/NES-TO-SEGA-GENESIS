...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_input_override_probe.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_input_override_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\input_override_probe_$BaseName.txt"
