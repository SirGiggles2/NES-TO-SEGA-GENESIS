...
try {
    Write-Host "=== WRITE WATCH ===" -ForegroundColor Cyan
    ...
    while (-not $proc.HasExited) {
        ...
        if (Test-Path $OutputPath) {
            ...
            if ($content -match 'WRITE WATCH COMPLETE') {
