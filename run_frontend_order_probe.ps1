...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_frontend_order_probe.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_frontend_order_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\frontend_order_probe_$BaseName.txt"
