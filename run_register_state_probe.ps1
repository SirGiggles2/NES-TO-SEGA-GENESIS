...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_register_state_probe.lua"
$TEMP_SCRIPT = "$PROJECT\diag\scripts\zelda_register_state_probe.runtime.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_register_state_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\register_state_probe_$BaseName.txt"
