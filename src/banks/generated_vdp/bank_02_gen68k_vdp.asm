...
b02_bra_961D_loop:  ; orig: b02_bra_961D_loop:
    MOVEA.L #$FF0084,A0  ; Fix X: ; (empty translation for DEC)  ; orig: C - - - - - 0x00962D 02:961D: D6 84     DEC ram_pos_Y_enemy,
    SUBQ.B  #1,(A0,D1.L)  ; ^
...
b02_bra_964D:  ; orig: b02_bra_964D:
    ...
    MOVEA.L #$FF0305,A0  ; Fix X: ; (empty translation for STA)  ; orig: C - - - - - 0x00966B 02:965B: 9D 05 03  STA ram_0302_ppu_buf
    MOVE.B  D0,(A0,D1.L)  ; ^
...
b02_bra_965F_loop:  ; orig: b02_bra_965F_loop:
    ...
    MOVEA.L #$FF0305,A0  ; Fix X: ; (empty translation for STA)  ; orig: C - - - - - 0x009671 02:9661: 9D 05 03  STA ram_0302_ppu_buf
    MOVE.B  D0,(A0,D1.L)  ; ^
...
loc_96A7:  ; orig: loc_96A7:
    ...
    MOVEA.L #$FF94AE,A0  ; Fix X: ; (empty translation for LDA)  ; orig: C - - - - - 0x0096CD 02:96BD: BD AE 94  LDA tbl_94AD_demo_ma
    MOVE.B  (A0,D1.L),D0  ; ^
...
loc_96C5_loop:  ; orig: loc_96C5_loop:
    ...
    MOVEA.L #$FF0305,A0  ; Fix X: ; (empty translation for STA)  ; orig: C - - - - - 0x0096DC 02:96CC: 9D 05 03  STA ram_0302_ppu_buf
    MOVE.B  D0,(A0,D1.L)  ; ^
