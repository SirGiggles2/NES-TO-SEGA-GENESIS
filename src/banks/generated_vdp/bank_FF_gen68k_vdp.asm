...
; if up
    ...
    MOVEQ   #0,D3             ; FIX: SBC #$00 = subtract borrow from subroutine
...
; try to spawn stepladder in front of link
    ...
    MOVEA.L #tbl_F1FD_stepladder_pos_X,A0
    ADD.B  (A0,D2.L),D0
    ...
    MOVEA.L #tbl_F201_stepladder_pos_Y,A0
    ADD.B  (A0,D2.L),D0
