...
bS2_bra_6DF5_loop:  ; orig: bS2_bra_6DF5_loop:
    ...
    ADD.B  #$0E,D0       ; ADC imm (uses X flag for carry)  ; orig: - D 1 - I - 0x006676 01:6DF6: 69 0E     ADC #$0E
...
; ram_000C_t01_data
    ...
    MOVE.B  #$00,D0  ; orig: - D 1 - I - 0x006687 01:6E07: A9 7F     LDA #$00
    MOVE.B  D0,ram_000E_t04_data  ; orig: - D 1 - I - 0x006689 01:6E09: 85 0E     STA ram_000E_t04_dat
    MOVE.B  #$02,D0  ; orig: - D 1 - I - 0x00668B 01:6E0B: A9 06     LDA #$02
...
; 00-0F, E9-FF
    MOVEA.L #$FF0240,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x006793 01:6F13: B9 40 02  LDA ram_spr_Y + $40,
    MOVE.B  (A0,D2.L),D0  ; ^
    ORI.B   #$20,D0  ; orig: - D 1 - I - 0x006796 01:6F16: 09 20     ORA #$20
    MOVEA.L #$FF0240,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x006798 01:6F18: 99 40 02  STA ram_spr_Y + $40,
    MOVE.B  D0,(A0,D2.L)  ; ^
...
sub_bat_6F29:  ; orig: sub_bat_6F29:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0067B7 01:6F37: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_6F45:  ; orig: bS2_bra_6F45:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0067D4 01:6F54: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
sub_bat_6F73:  ; orig: sub_bat_6F73:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x006801 01:6F81: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_6F8F:  ; orig: bS2_bra_6F8F:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x00681E 01:6F9E: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
sub_bat_70AB:  ; orig: sub_bat_70AB:
    ...
    MOVEA.L #$FF0380,A0  ; Fix X: ; (empty translation for DEC)  ; orig: - D 1 - I - 0x006939 01:70B9: DE 80 03  DEC ram_0380_enemy,X
    SUBQ.B  #1,(A0,D1.L)  ; ^
...
; / 04
    ...
    MOVEA.L #$FF0254,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x006A74 01:71F4: 9D 54 02  STA ram_spr_Y + $54,
    MOVE.B  D0,(A0,D1.L)  ; ^
...
; * 04
    ...
    MOVEA.L #$FF0257,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x006A90 01:7210: 9D 57 02  STA ram_spr_X + $54,
    MOVE.B  D0,(A0,D1.L)  ; ^
    MOVE.B  #$3E,D0  ; orig: - D 1 - I - 0x006A93 01:7213: A9 3E     LDA #$3E
    MOVEA.L #$FF0255,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x006A95 01:7215: 9D 55 02  STA ram_spr_T + $54,
    MOVE.B  D0,(A0,D1.L)  ; ^
...
bS2_bra_723C:  ; orig: bS2_bra_723C:
    MOVEA.L #$FF0256,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x006ABC 01:723C: 9D 56 02  STA ram_spr_A + $54,
    MOVE.B  D0,(A0,D1.L)  ; ^
...
sub_bat_7328:  ; orig: sub_bat_7328:
    ...
    MOVEA.L #$FF00AC,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x006BB7 01:7337: B5 AC     LDA ram_room_item_fl
    MOVE.B  (A0,D1.L),D0  ; ^
    BMI     bS2_bra_7324_RTS             ; BMI  ; orig: - D 1 - I - 0x006BB9 01:7339: 30 E9     BMI bS2_bra_7324_RTS
    MOVEA.L #$FF0098,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x006BBB 01:733B: B5 98     LDA ram_drop_id_room
    MOVE.B  (A0,D1.L),D0  ; ^
...
; Y = 01
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDY)  ; orig: - D 1 - I - 0x007063 01:77E3: BC 4F 03  LDY ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D2  ; ^
...
; 01-0C
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0070AA 01:782A: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
    ...
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0070B1 01:7831: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
...
loc_bat_79D0:  ; orig: loc_bat_79D0:
    ...
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007253 01:79D3: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_79FD:  ; orig: bS2_bra_79FD:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007280 01:7A00: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
    MOVEA.L #ram_0405_enemy,A0
    MOVE.B  (A0,D1.L),D2
...
bS2_bra_7A10:  ; orig: bS2_bra_7A10:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x007299 01:7A19: 99 4F 03  STA ram_obj_id_enemy
    MOVE.B  D0,(A0,D2.L)  ; ^
...
bS2_bra_7A25:  ; orig: bS2_bra_7A25:
    ...
    MOVEA.L #$FF042C,A0  ; Fix X: ; (empty translation for INC)  ; orig: - D 1 - I - 0x0072A9 01:7A29: FE 2C 04  INC ram_042B_enemy,X
    ADDQ.B  #1,(A0,D1.L)  ; ^
...
; bzk optimize, A is always 08
    ...
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0072B3 01:7A33: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
...
sub_bat_7AC5:  ; orig: sub_bat_7AC5:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007350 01:7AD0: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_7ADF:  ; orig: bS2_bra_7ADF:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007374 01:7AF4: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
    CMPI.B  #$53,D0  ; orig: - D 1 - I - 0x007377 01:7AF7: C9 53     CMP #$53
    BCC     bS2_bra_7B3A_getting_hit             ; BCC  ; orig: - D 1 - I - 0x007379 01:7AF9: 90 3F     BCC bra_7B3A_getting
...
bS2_bra_7B20:  ; orig: bS2_bra_7B20:
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0073A0 01:7B20: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
    CMPI.B  #$55,D0  ; orig: - D 1 - I - 0x0073A3 01:7B23: C9 55     CMP #$55
    BCC     bS2_bra_7B30_normal_projectile             ; BCC  ; orig: - D 1 - I - 0x0073A5 01:7B25: 90 09     BCC bra_7B30_normal_
    CMPI.B  #$5B,D0  ; orig: - D 1 - I - 0x0073A7 01:7B27: C9 5B     CMP #$5B
    BCS     bS2_bra_7B30_normal_projectile             ; BCS  ; orig: - D 1 - I - 0x0073A9 01:7B29: B0 05     BCS bra_7B30_normal_
...
bS2_bra_7B3A_getting_hit:  ; orig: bS2_bra_7B3A_getting_hit:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDY)  ; orig: - D 1 - I - 0x0073BF 01:7B3F: BC 4F 03  LDY ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D2  ; ^
    MOVEA.L #$FF7A4A,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0073C2 01:7B42: B9 4A 7A  LDA tbl_7A4B_damage_
    MOVE.B  (A0,D2.L),D0  ; ^
...
loc_bat_7B4F:  ; orig: loc_bat_7B4F:
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDY)  ; orig: - D 1 - I - 0x0073CF 01:7B4F: BC 4F 03  LDY ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D2  ; ^
...
bS2_bra_7B67_loop:  ; orig: bS2_bra_7B67_loop:
    ...
    BCC     bS2_bra_7BA9_death             ; BCC  ; orig: - D 1 - I - 0x007404 01:7B84: 90 23     BCC bS2_bra_7BA9_death
...
sub_7C16:  ; orig: sub_7C16:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x00749D 01:7C1D: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
sub_bat_7C54:  ; orig: sub_bat_7C54:
    ...
    MOVEA.L #$FF0485,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0074D9 01:7C59: BD 85 04  LDA ram_hp_ememy - $
    MOVE.B  (A0,D1.L),D0  ; ^
    ...
    MOVEA.L #$FF0485,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x0074E3 01:7C63: 9D 85 04  STA ram_hp_ememy - $
    MOVE.B  D0,(A0,D1.L)  ; ^
...
loc_bat_7D29:  ; orig: loc_bat_7D29:
    ...
    MOVEA.L #$FF7D25,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x0075B9 01:7D39: B9 25 7D  LDA tbl_7D26 - $01,Y
    MOVE.B  (A0,D2.L),D0  ; ^
...
sub_7D86:  ; orig: sub_7D86:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007611 01:7D91: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
    ...
    MOVEA.L #$FF0485,A0  ; Fix X: ; (empty translation for STA)  ; orig: - D 1 - I - 0x00761A 01:7D9A: 9D 85 04  STA ram_hp_ememy - $
    MOVE.B  D0,(A0,D1.L)  ; ^
...
bS2_bra_7DAA:  ; orig: bS2_bra_7DAA:
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x00762A 01:7DAA: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_7E6C:  ; orig: bS2_bra_7E6C:
    ...
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007708 01:7E88: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x00770F 01:7E8F: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_7E9E:  ; orig: bS2_bra_7E9E:
    ...
    MOVEA.L #$FF04BF,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007723 01:7EA3: BD BF 04  LDA ram_attr_enemy -
    MOVE.B  (A0,D1.L),D0  ; ^
...
bS2_bra_7EB0:  ; orig: bS2_bra_7EB0:
    ...
    MOVEA.L #$FF034F,A0  ; Fix X: ; (empty translation for LDA)  ; orig: - D 1 - I - 0x007735 01:7EB5: BD 4F 03  LDA ram_obj_id_enemy
    MOVE.B  (A0,D1.L),D0  ; ^
