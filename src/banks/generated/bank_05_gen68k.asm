...
; * 08
    ...
    BCS     bra_80B3             ; BCC  ; orig: C - - - - - 0x0140B3 05:80A3: 90 0E     BCC bra_80B3
...
ofs_overworld_pause_handler_810F_09:  ; orig: ofs_overworld_pause_handler_810F_09:
    ...
    BCS     bra_8151_RTS             ; BCC  ; orig: C - - - - - 0x01412D 05:811D: 90 32     BCC bra_8151_RTS
...
bra_81E7:  ; orig: bra_81E7:
    ...
    BCC     bra_81FD             ; BCS  ; orig: C - - - - - 0x014207 05:81F7: B0 04     BCS bra_81FD
...
bra_8228:  ; orig: bra_8228:
    ...
    BCS     bra_8239             ; BCC  ; orig: C - - - - - 0x014243 05:8233: 90 04     BCC bra_8239
...
bra_8260:  ; orig: bra_8260:
    ...
    BCC     bra_8276             ; BCS  ; orig: C - - - - - 0x014280 05:8270: B0 04     BCS bra_8276
...
bra_8288:  ; orig: bra_8288:
    ...
    BCS     bra_8299             ; BCC  ; orig: C - - - - - 0x0142A3 05:8293: 90 04     BCC bra_8299
...
ofs_017_831F_02:  ; orig: ofs_017_831F_02:
    ...
    BCC     bra_8336             ; BCS  ; orig: C - - - - - 0x014341 05:8331: B0 03     BCS bra_8336    ; co
...
ofs_017_835C_05:  ; orig: ofs_017_835C_05:
    ...
    BCC     bra_836B             ; BCS  ; orig: C - - - - - 0x014375 05:8365: B0 04     BCS bra_836B    ; co
...
bra_83F1_loop:  ; orig: bra_83F1_loop:
    ...
    BCC     bra_840A             ; BCS  ; orig: C - - - - - 0x01440C 05:83FC: B0 0C     BCS bra_840A
...
loc_8404_loop:  ; orig: loc_8404_loop:
    ...
    BCS     bra_83F1_loop             ; BCC  ; orig: C - - - - - 0x014417 05:8407: 90 E8     BCC bra_83F1_loop
...
ofs_018_84E8_05:  ; orig: ofs_018_84E8_05:
    ...
    BCC     bra_84FD             ; BCS  ; orig: C - - - - - 0x014507 05:84F7: B0 04     BCS bra_84FD    ; co
...
sub_8506:  ; orig: sub_8506:
    ...
    BCC     bra_8515             ; BCS  ; orig: C - - - - - 0x01451A 05:850A: B0 09     BCS bra_8515
...
bra_8515:  ; orig: bra_8515:
    ...
    BCC     bra_8520_RTS             ; BCS  ; orig: C - - - - - 0x01452B 05:851B: B0 03     BCS bra_8520_RTS
...
bra_8521_infinite_loop:  ; orig: bra_8521_infinite_loop:
    MOVE.B  PPU_REG_$2002  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!,D0  ; orig: C - - - - - 0x014531 05:8521: AD 02 20  LDA $2002
    ...
    MOVE.B  PPU_REG_$2002  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!,D0  ; orig: C - - - - - 0x014538 05:8528: AD 02 20  LDA $2002
...
; Y = FF
    ...
    BCC     bra_858C             ; BCS  ; orig: C - - - - - 0x014552 05:8542: B0 48     BCS bra_858C
    ...
    BCS     bra_856D             ; BCC  ; orig: C - - - - - 0x01455C 05:854C: 90 1F     BCC bra_856D
...
bra_8550_garbage_loop:  ; orig: bra_8550_garbage_loop:
    ...
    MOVE.B  PPU_REG_$2002  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!,D0  ; orig: C - - - - - 0x014569 05:8559: AD 02 20  LDA $2002
    ...
    MOVE.B  D0,PPU_REG_$2006  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x014570 05:8560: 8D 06 20  STA $2006
    MOVE.B  D2,PPU_REG_$2006  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x014573 05:8563: 8C 06 20  STY $2006
    MOVE.B  PPU_REG_$2007  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!,D0  ; orig: C - - - - - 0x014576 05:8566: AD 07 20  LDA $2007
    MOVE.B  PPU_REG_$2007  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!,D0  ; orig: C - - - - - 0x014579 05:8569: AD 07 20  LDA $2007
...
bra_856F_garbage_loop:  ; orig: bra_856F_garbage_loop:
    ...
    MOVE.B  D0,PPU_REG_$2000  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x01458E 05:857E: 8D 00 20  STA $2000
    MOVE.B  ram_scroll_X,D0  ; orig: C - - - - - 0x014591 05:8581: A5 FD     LDA ram_scroll_X
    MOVE.B  D0,PPU_REG_$2005  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x014593 05:8583: 8D 05 20  STA $2005
    MOVE.B  #$00,D0  ; orig: C - - - - - 0x014596 05:8586: A9 00     LDA #$00    ; scroll
    MOVE.B  D0,PPU_REG_$2005  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x014598 05:8588: 8D 05 20  STA $2005
...
bra_858C:  ; orig: bra_858C:
    ...
    BCC     bra_8593             ; BCS  ; orig: C - - - - - 0x01459E 05:858E: B0 03     BCS bra_8593
...
bra_8593:  ; orig: bra_8593:
    ...
    MOVE.B  D0,PPU_REG_$2000  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x0145A9 05:8599: 8D 00 20  STA $2000
...
bra_8820:  ; orig: bra_8820:
    MOVE.B  #$06,($FFEE80).l  ; CANARY: took bra_8820 (ram_005A==0)
...
bra_8895:  ; orig: bra_8895:
    ...
    BCC     bra_88AC             ; BCS  ; orig: C - - - - - 0x0148B4 05:88A4: B0 06     BCS bra_88AC
    CMPI.B  #$32,D2  ; orig: C - - - - - 0x0148B6 05:88A6: C0 32     CPY #$32
    BCS     bra_88AC             ; BCC  ; orig: C - - - - - 0x0148B8 05:88A8: 90 02     BCC bra_88AC
...
loc_88C7:  ; orig: loc_88C7:
    ...
    BCC     bra_88E5_spawn_a_group_of_enemies             ; BCS  ; orig: C - - - - - 0x0148E4 05:88D4: B0 0F     BCS bra_88E5_spawn_a
...
bra_89B6_not_valid:  ; orig: bra_89B6_not_valid:
    ...
    BCS     bra_89BD_not_overflow             ; BCC  ; orig: C - - - - - 0x0149C9 05:89B9: 90 02     BCC bra_89BD_not_ove
...
bra_89BD_not_overflow:  ; orig: bra_89BD_not_overflow:
    ...
    BCS     bra_89A0_loop             ; BCC  ; orig: C - - - - - 0x0149CF 05:89BF: 90 DF     BCC bra_89A0_loop
...
sub_8A04_check_for_valid_spawn_position:  ; orig: sub_8A04_check_for_valid_spawn_position:
    ...
    BCC     bra_8A2D_not_valid             ; BCS  ; orig: C - - - - - 0x014A21 05:8A11: B0 1A     BCS bra_8A2D_not_val
sub_0x014A23:  ; orig: sub_0x014A23:
    ...
    BCC     bra_8A2B_valid             ; BCS  ; orig: C - - - - - 0x014A2D 05:8A1D: B0 0C     BCS bra_8A2B_valid
    ...
    BCS     bra_8A2D_not_valid             ; BCC  ; orig: C - - - - - 0x014A39 05:8A29: 90 02     BCC bra_8A2D_not_val
...
; code for dungeons only, not for overworld
    ...
    MOVEA.W ($FF0000+ram_0000_t13_data).l,A1  ; FIX: AND (zp),Y - load pointer
    MOVE.B  ($FF0000,A1,D2.W),D3  ; FIX: load (ptr+Y) into D3
...
bra_8BFD_loop:  ; orig: bra_8BFD_loop:
    ...
    BCS     bra_8C19_RTS             ; BCC  ; orig: C - - - - - 0x014C14 05:8C04: 90 13     BCC bra_8C19_RTS
    CMPI.B  #$2E,D0  ; orig: C - - - - - 0x014C16 05:8C06: C9 2E     CMP #$2E
    BCS     bra_8C0E             ; BCC  ; orig: C - - - - - 0x014C18 05:8C08: 90 04     BCC bra_8C0E
    CMPI.B  #$49,D0  ; orig: C - - - - - 0x014C1A 05:8C0A: C9 49     CMP #$49
    BCS     bra_8C19_RTS             ; BCC  ; orig: C - - - - - 0x014C1C 05:8C0C: 90 0B     BCC bra_8C19_RTS
...
ofs_019_8C28_02:  ; orig: ofs_019_8C28_02:
    ...
    BCS     bra_8C26             ; BCC  ; orig: C - - - - - 0x014C3F 05:8C2F: 90 F5     BCC bra_8C26
...
bra_8C34_loop:  ; orig: bra_8C34_loop:
    ...
    BCC     bra_8C47             ; BCS  ; orig: C - - - - - 0x014C4B 05:8C3B: B0 0A     BCS bra_8C47
...
ofs_link_death_8D0D_0A:  ; orig: ofs_link_death_8D0D_0A:
    ...
    BCC     bra_8D1B             ; BCS  ; orig: C - - - - - 0x014D27 05:8D17: B0 02     BCS bra_8D1B
...
sub_8D8C:  ; orig: sub_8D8C:
    ...
    BCC     bra_8D9E             ; BCS  ; orig: C - - - - - 0x014DAA 05:8D9A: B0 02     BCS bra_8D9E
...
; ram_0000_t64
    ...
    BCS     bra_8DFB             ; BCC  ; orig: C - - - - - 0x014DE2 05:8DD2: 90 27     BCC bra_8DFB
...
bra_8DF4:  ; orig: bra_8DF4:
    ...
    BCS     bra_8DD4             ; BCC  ; orig: C - - - - - 0x014E09 05:8DF9: 90 D9     BCC bra_8DD4
...
sub_0x014EE7:  ; orig: sub_0x014EE7:
    ...
    BCC     bra_8EC6_RTS             ; BCS  ; orig: C - - - - - 0x014EF1 05:8EE1: B0 E3     BCS bra_8EC6_RTS
...
; in an infinite loop because of no Y check
    ...
    BCC     bra_8F02             ; BCS  ; orig: C - - - - - 0x014F0A 05:8EFA: B0 06     BCS bra_8F02
...
loc_8FA8:  ; orig: loc_8FA8:
    ...
    BCS     bra_8FC9             ; BCC  ; orig: C - - - - - 0x014FBF 05:8FAF: 90 18     BCC bra_8FC9
...
bra_8FDC:  ; orig: bra_8FDC:
    ...
    BCS     bra_8FCD_loop             ; BCC  ; orig: C - - - - - 0x01501D 05:900D: 90 BE     BCC bra_8FCD_loop
...
; / 08
    ...
    BCS     bra_907A             ; BCC  ; orig: C - - - - - 0x015081 05:9071: 90 07     BCC bra_907A
...
; code for overworld only, not for dungeons
    ...
    BCC     bra_9103             ; BCS  ; orig: C - - - - - 0x015108 05:90F8: B0 09     BCS bra_9103
    ...
    BCS     bra_9105_not_overflow             ; BCC  ; orig: C - - - - - 0x015111 05:9101: 90 02     BCC bra_9105_not_ove
bra_9103:  ; orig: bra_9103:
    MOVE.B  #$07,D0  ; orig: C - - - - - 0x015113 05:9103: A9 07     LDA #$07
bra_9105_not_overflow:  ; orig: bra_9105_not_overflow:
    MOVEA.W ($FF0000+ram_0000_t13_data).l,A1  ; FIX: ORA (zp),Y - load pointer
    MOVE.B  ($FF0000,A1,D2.W),D3  ; FIX: load (ptr+Y) into D3
...
bra_9187_loop:  ; orig: bra_9187_loop:
    ...
    BCS     bra_919A             ; BCC  ; orig: C - - - - - 0x0151A3 05:9193: 90 05     BCC bra_919A
    CMP.B   tbl_9170(D2.L),D0  ; orig: C - - - - - 0x0151A5 05:9195: D9 70 91  CMP tbl_9170,Y
    BCS     bra_91D6             ; BCC  ; orig: C - - - - - 0x0151A8 05:9198: 90 3C     BCC bra_91D6
...
bra_91A2:  ; orig: bra_91A2:
    ...
    BCS     bra_91BC             ; BCC  ; orig: C - - - - - 0x0151BF 05:91AF: 90 0B     BCC bra_91BC
    CMP.B   tbl_9170(D2.L),D0  ; orig: C - - - - - 0x0151C1 05:91B1: D9 70 91  CMP tbl_9170,Y
    BCC     bra_91BC             ; BCS  ; orig: C - - - - - 0x0151C4 05:91B4: B0 06     BCS bra_91BC
...
bra_91BE_loop:  ; orig: bra_91BE_loop:
    ...
    BCS     bra_91D1             ; BCC  ; orig: C - - - - - 0x0151DA 05:91CA: 90 05     BCC bra_91D1
    CMP.B   tbl_9178(D2.L),D0  ; orig: C - - - - - 0x0151DC 05:91CC: D9 78 91  CMP tbl_9178,Y
    BCS     bra_91D6             ; BCC  ; orig: C - - - - - 0x0151DF 05:91CF: 90 05     BCC bra_91D6
...
bra_9297_loop:  ; orig: bra_9297_loop:
    ...
    BCS     bra_92BA             ; BCC  ; orig: C - - - - - 0x0152BC 05:92AC: 90 0C     BCC bra_92BA
    ...
    BCS     bra_92D0             ; BCC  ; orig: - - - - - - 0x0152C8 05:92B8: 90 16     BCC bra_92D0
...
bra_92C6:  ; orig: bra_92C6:
    ...
    SUB.B   ram_0560(D2.L),D0  ; FIX: SEC+SBC ram_0560,Y -> SUB.B
...
; code for dungeons only, not for overworld
    ...
    BCS     bra_92FB             ; BCC  ; orig: C - - - - - 0x0152FD 05:92ED: 90 0C     BCC bra_92FB
    ...
    BCS     bra_9316             ; BCC  ; orig: C - - - - - 0x015309 05:92F9: 90 1B     BCC bra_9316
bra_92FB:  ; orig: bra_92FB:
    CMP.B   ram_enemy_cnt,D0  ; orig: C - - - - - 0x01530B 05:92FB: CD 4E 03  CMP ram_enemy_cnt
    BCC     bra_9316             ; BCS  ; orig: C - - - - - 0x01530E 05:92FE: B0 16     BCS bra_9316
    ...
    ADD.B   ram_0560(D2.L),D0  ; FIX: CLC+ADC ram_0560,Y -> ADD.B
    ...
    BCS     bra_930F_not_overflow             ; BCC  ; orig: C - - - - - 0x01531B 05:930B: 90 02     BCC bra_930F_not_ove
...
bra_A3FE_loop:  ; orig: bra_A3FE_loop:
    ...
    BCS     bra_A40E             ; BCC  ; orig: C - - - - - 0x016417 05:A407: 90 05     BCC bra_A40E
...
bra_A460_loop:  ; orig: bra_A460_loop:
    ...
    BCC     bra_A474             ; BCS  ; orig: C - - - - - 0x01647E 05:A46E: B0 04     BCS bra_A474
...
bra_A4A5_loop:  ; orig: bra_A4A5_loop:
    ...
    BCC     bra_A4BE             ; BCS  ; orig: C - - - - - 0x0164BF 05:A4AF: B0 0D     BCS bra_A4BE
    CMPI.B  #$DC,D0  ; orig: C - - - - - 0x0164C1 05:A4B1: C9 DC     CMP #$DC
    BCC     bra_A4B9             ; BCS  ; orig: C - - - - - 0x0164C3 05:A4B3: B0 04     BCS bra_A4B9
...
loc_A4FC:  ; orig: loc_A4FC:
    ...
    BCC     bra_A528             ; BCS  ; orig: C - - - - - 0x01651A 05:A50A: B0 1C     BCS bra_A528
...
bra_A518:  ; orig: bra_A518:
    ...
    BCC     bra_A528             ; BCS  ; orig: C - - - - - 0x016534 05:A524: B0 02     BCS bra_A528
...
bra_A555:  ; orig: bra_A555:
    ...
    BCS     bra_A5A5             ; BCC  ; orig: C - - - - - 0x016567 05:A557: 90 4C     BCC bra_A5A5
    ...
    BCS     bra_A562             ; BCC  ; orig: C - - - - - 0x01656F 05:A55F: 90 01     BCC bra_A562
...
bra_A584_loop:  ; orig: bra_A584_loop:
    ...
    BCC     bra_A59E             ; BCS  ; orig: C - - - - - 0x0165A9 05:A599: B0 03     BCS bra_A59E
...
bra_A614:  ; orig: bra_A614:
    ...
    BCC     bra_A631             ; BCS  ; orig: C - - - - - 0x016631 05:A621: B0 0E     BCS bra_A631
...
bra_A689:  ; orig: bra_A689:
    ...
    ADD.B   tbl_A5EF(D1.L),D0  ; FIX: CLC+ADC tbl_A5EF,X -> ADD.B
...
; ram_0001_t14_ppu_addr_lo
    ...
    BCS     bra_A6C3             ; BCC  ; orig: C - - - - - 0x0166CA 05:A6BA: 90 07     BCC bra_A6C3
...
bra_A6DD:  ; orig: bra_A6DD:
    ...
    BCS     bra_A6E2             ; BCC  ; orig: C - - - - - 0x0166EF 05:A6DF: 90 01     BCC bra_A6E2
...
loc_A7A8:  ; orig: loc_A7A8:
    ...
    BCS     bra_A77A_loop             ; BCC  ; orig: C - - - - - 0x0167BE 05:A7AE: 90 CA     BCC bra_A77A_loop
    ...
    BCC     bra_A7C0_RTS             ; BCS  ; orig: C - - - - - 0x0167CB 05:A7BB: B0 03     BCS bra_A7C0_RTS
...
; bzk optimize, write LDY 00 here for readability
    ...
    BCS     bra_A7E0             ; BCC  ; orig: C - - - - - 0x0167D3 05:A7C3: 90 1B     BCC bra_A7E0    ; if
    CMPI.B  #$F3,D0  ; orig: C - - - - - 0x0167D5 05:A7C5: C9 F3     CMP #$F3
    BCC     bra_A7E0             ; BCS  ; orig: C - - - - - 0x0167D7 05:A7C7: B0 17     BCS bra_A7E0    ; if
...
ofs_023_A877_01:  ; orig: ofs_023_A877_01:
    ...
    BCS     bra_A885             ; BCC  ; orig: C - - - - - 0x016891 05:A881: 90 02     BCC bra_A885
...
ofs_023_A897_03:  ; orig: ofs_023_A897_03:
    ...
    BCC     bra_A8AA_RTS             ; BCS  ; orig: C - - - - - 0x0168B2 05:A8A2: B0 06     BCS bra_A8AA_RTS
...
ofs_023_A8AB_04:  ; orig: ofs_023_A8AB_04:
    ...
    MOVE.B  D0,PPU_REG_$2000  ; !! PPU REGISTER - NEEDS VDP TRANSLATION !!  ; orig: C - - - - - 0x0168C8 05:A8B8: 8D 00 20  STA $2000
...
bra_A90C_loop:  ; orig: bra_A90C_loop:
    ...
    BCS     bra_A90C_loop             ; FIX v393: BCC->BCS (NES CMP;BCC = loop while < imm = 68K BCS)  ; orig: C - - - - - 0x01692B 05:A91B: 90 EF     BCC bra_A90C_loop
...
bra_A95B_loop:  ; orig: bra_A95B_loop:
    ...
    BCS     bra_A95B_loop             ; FIX v393: BCC->BCS (NES CPX;BCC = loop while < imm = 68K BCS)  ; orig: C - - - - - 0x016978 05:A968: 90 F1     BCC bra_A95B_loop
...
; * 08
    ...
    ADDX.B  D3,D0  ; FIX v602: ADC ram_0002_t09_data
    ...
    ADDX.B  D3,D0  ; FIX v602: ADC ram_0002_t09_data + $01
...
bra_AAA7:  ; orig: bra_AAA7:
    ...
    BCC     bra_AAF0_RTS             ; FIX v396: BCS->BCC (NES CMP;BCS = branch if A>=imm = 68K BCC)  ; orig: C - - - - - 0x016ACA 05:AABA: B0 34     BCS bra_AAF0_RTS
...
; A =
    ...
    BCS     bra_AB0E_00_0F             ; FIX v396: BCC->BCS (NES CPX;BCC = branch if X<imm = 68K BCS)  ; orig: C - - - - - 0x016B05 05:AAF5: 90 17     BCC bra_AB0E_00_0F
...
bra_AB3E_copy_loop:
    MOVE.B  (A0)+,(A1)+
    DBF     D3,bra_AB3E_copy_loop
    MOVE.B  ram_dungeon_level,D2
    BNE     bra_AB3E_dungeon
...
bra_b05_copy_block_to_ff_loop:
    MOVE.B  (A0)+,(A1)+
    DBF     D4,bra_b05_copy_block_to_ff_loop
    RTS
...
; / 08
    ...
    BCS     bra_ABF5             ; FIX v396: BCC->BCS (NES CMP;BCC = branch if A<imm = 68K BCS)  ; orig: C - - - - - 0x016BFF 05:ABEF: 90 04     BCC bra_ABF5
    CMPI.B  #$F3,D0  ; orig: C - - - - - 0x016C01 05:ABF1: C9 F3     CMP #$F3
    BCS     bra_ABFF             ; FIX v396: BCC->BCS (NES CMP;BCC = branch if A<imm = 68K BCS)  ; orig: C - - - - - 0x016C03 05:ABF3: 90 0A     BCC bra_ABFF
...
ofs_040_AC10_04:  ; orig: ofs_040_AC10_04:
    ...
    BCC     bra_AC27             ; FIX v396: BCS->BCC (NES BCS = branch if A>=imm = 68K BCC)  ; orig: C - - - - - 0x016C23 05:AC13: B0 12     BCS bra_AC27
...
bra_B0A0:  ; orig: bra_B0A0:
    ...
    BCS     bra_B0AB             ; BCC  ; orig: C - - - - - 0x0170B5 05:B0A5: 90 04     BCC bra_B0AB
    CMPI.B  #$05,D0  ; orig: C - - - - - 0x0170B7 05:B0A7: C9 05     CMP #$05
    BCS     bra_B0AD             ; BCC  ; orig: C - - - - - 0x0170B9 05:B0A9: 90 02     BCC bra_B0AD
...
sub_0x0171F6:  ; orig: sub_0x0171F6:
    ...
    BCC     bra_B1FD             ; BCS  ; orig: C - - - - - 0x017204 05:B1F4: B0 07     BCS bra_B1FD
...
sub_B23A:  ; orig: sub_B23A:
    ...
    BCC     bra_B24C             ; BCS  ; orig: C - - - - - 0x017254 05:B244: B0 06     BCS bra_B24C
...
sub_B282:  ; orig: sub_B282:
    ...
    BCC     bra_B293             ; BCS  ; orig: C - - - - - 0x01729C 05:B28C: B0 05     BCS bra_B293
...
bra_B2D7_loop:  ; orig: bra_B2D7_loop:
    ...
    AND.B   tbl_bat_6DC3_direction(D2.L),D0  ; FIX: AND tbl_bat_6DC3_direction,Y
    ...
    BCC     bra_B2F3             ; BCS  ; orig: C - - - - - 0x0172FB 05:B2EB: B0 06     BCS bra_B2F3
...
bra_B34D:  ; orig: bra_B34D:
    ...
    AND.B   tbl_B296(D2.L),D0  ; FIX: AND tbl_B296,Y
...
bra_B3AF:  ; orig: bra_B3AF:
    ...
    BCC     bra_B3F3_RTS             ; BCS  ; orig: C - - - - - 0x0173D4 05:B3C4: B0 2D     BCS bra_B3F3_RTS
...
; if dungeon
    ...
    BCS     bra_B46E_RTS             ; BCC  ; orig: C - - - - - 0x017437 05:B427: 90 45     BCC bra_B46E_RTS
    CMPI.B  #$74,D0  ; orig: C - - - - - 0x017439 05:B429: C9 74     CMP #$74
    BCC     bra_B46E_RTS             ; BCS  ; orig: C - - - - - 0x01743B 05:B42B: B0 41     BCS bra_B46E_RTS
...
bra_B46F:  ; orig: bra_B46F:
    ...
    BCS     bra_B46E_RTS             ; BCC  ; orig: C - - - - - 0x01748B 05:B47B: 90 F1     BCC bra_B46E_RTS
    CMPI.B  #con_collision_tile + $74,D0  ; orig: C - - - - - 0x01748D 05:B47D: C9 74     CMP #con_collision_t
    BCC     bra_B46E_RTS             ; BCS  ; orig: C - - - - - 0x01748F 05:B47F: B0 ED     BCS bra_B46E_RTS
...
bra_B486:  ; orig: bra_B486:
    ...
    BCS     bra_B49F             ; BCC  ; orig: C - - - - - 0x0174A2 05:B492: 90 0B     BCC bra_B49F
...
bra_B5DA_loop:  ; orig: bra_B5DA_loop:
    ...
    AND.B   tbl_B577(D1.L),D0  ; FIX: AND tbl_B577,X
...
; if dungeon
    ...
    BCS     bra_B5FE             ; BCC  ; orig: C - - - - - 0x01760A 05:B5FA: 90 02     BCC bra_B5FE
...
bra_B5FE:  ; orig: bra_B5FE:
    ...
    AND.B   tbl_0x01E6CE_8_bits(D2.L),D0  ; FIX: AND tbl_0x01E6CE_8_bits,Y
...
sub_B641:  ; orig: sub_B641:
    ...
    BCS     bra_B665             ; BCC  ; orig: C - - - - - 0x017656 05:B646: 90 1D     BCC bra_B665
    ...
    AND.B   tbl_0x01E6CE_8_bits(D1.L),D0  ; FIX: AND tbl_0x01E6CE_8_bits,X
...
bra_B6E6:  ; orig: bra_B6E6:
    ...
    BCS     bra_B710             ; BCC  ; orig: C - - - - - 0x017702 05:B6F2: 90 1C     BCC bra_B710
    ...
    BCS     bra_B710             ; BCC  ; orig: C - - - - - 0x01770C 05:B6FC: 90 12     BCC bra_B710
    MOVE.B  #$1E,D0  ; orig: C - - - - - 0x01770E 05:B6FE: A9 1E     LDA #$1E
    CMPI.B  #$10,D1  ; orig: C - - - - - 0x017710 05:B700: E0 10     CPX #$10
    BCS     bra_B710             ; BCC  ; orig: C - - - - - 0x017712 05:B702: 90 0C     BCC bra_B710
    ...
    BCS     bra_B710             ; BCC  ; orig: C - - - - - 0x01771C 05:B70C: 90 02     BCC bra_B710
...
bra_B717:  ; orig: bra_B717:
    ...
    BCS     bra_B6C4_loop             ; BCC  ; orig: C - - - - - 0x01772A 05:B71A: 90 A8     BCC bra_B6C4_loop
...
; con_item_candle
    ...
    BCS     bra_B77B             ; BCC  ; orig: C - - - - - 0x017787 05:B777: 90 02     BCC bra_B77B
...
; / 08
    ...
    BCC     bra_B7C8             ; BCS  ; orig: C - - - - - 0x0177B6 05:B7A6: B0 20     BCS bra_B7C8
