...
bra_974F:  ; orig: bra_974F:
    ...
    BCC     bra_9796             ; BCS  ; orig: C - - - - - 0x00977A 02:976A: B0 2A     BCS bra_9796
...
bra_97B2:  ; orig: bra_97B2:
    ...
    BCC     bra_97BC             ; BCS  ; orig: C - - - - - 0x0097C4 02:97B4: B0 06     BCS bra_97BC
...
sub_98F5:  ; orig: sub_98F5:
    ...
    BCS     bra_9907             ; BCC  ; orig: C - - - - - 0x009910 02:9900: 90 05     BCC bra_9907
...
bra_9907:  ; orig: bra_9907:
    ...
    BCC     bra_9917             ; BCS  ; orig: C - - - - - 0x00991E 02:990E: B0 07     BCS bra_9917
    LSR.B   #1,D0           ; LSR A  ; orig: C - - - - - 0x009920 02:9910: 4A        LSR
    CMPI.B  #$B9,D2  ; orig: C - - - - - 0x009921 02:9911: C0 B9     CPY #$B9
    BCC     bra_9917             ; BCS  ; orig: C - - - - - 0x009923 02:9913: B0 02     BCS bra_9917
...
bra_9BAE_loop:
    ...
    BCS     bra_9BD0             ; BCC  ; orig: C - - - - - 0x009BD4 02:9BC4: 90 0A     BCC bra_9BD0
...
bra_9F57_loop:  ; orig: bra_9F57_loop:
    ...
    BCS     bra_9F57_loop             ; BCC  ; orig: C - - - - - 0x009F73 02:9F63: 90 F2     BCC bra_9F57_loop
...
sub_A0F0:  ; orig: sub_A0F0:
    ...
    ADD.B   tbl_9E02_pos_Y(D1.L),D0  ; FIX v448: ADC abs,X (CLC+ADC = simple ADD)  ; orig: C - - - - - 0x00A105 02:A0F5: 7D 02 9E  ADC tbl_9E02_pos_Y,X
...
bra_A48A_loop:  ; orig: bra_A48A_loop:
    ...
    BCS     bra_A48A_loop             ; BCC  ; orig: C - - - - - 0x00A4B1 02:A4A1: 90 E7     BCC bra_A48A_loop
...
ofs_010_A5DF_01:  ; orig: ofs_010_A5DF_01:
    ...
    BCS     bra_A5FE_cursor_at_some_slot             ; BCC  ; orig: C - - - - - 0x00A602 02:A5F2: 90 0A     BCC bra_A5FE_cursor_
...
sub_A921_close_curtain:  ; orig: sub_A921_close_curtain:
    ...
    BCC     bra_A939_RTS             ; BCS  ; orig: C - - - - - 0x00A941 02:A931: B0 06     BCS bra_A939_RTS
...
loc_AA33:  ; orig: loc_AA33:
    ...
    BCS     bra_AA4F_RTS             ; BCC  ; orig: C - - - - - 0x00AA48 02:AA38: 90 15     BCC bra_AA4F_RTS
...
ofs_013_AAA9_02:  ; orig: ofs_013_AAA9_02:
    ...
    BCS     bra_AAC6_RTS             ; BCC  ; orig: C - - - - - 0x00AAC4 02:AAB4: 90 10     BCC bra_AAC6_RTS
...
bra_AB69:  ; orig: bra_AB69:
    ...
    BCC     bra_AB7B_RTS             ; BCS  ; orig: C - - - - - 0x00AB84 02:AB74: B0 05     BCS bra_AB7B_RTS
...
bra_AC00_1st_quest:  ; orig: bra_AC00_1st_quest:
    ...
    BCS     bra_AC15_RTS             ; BCC  ; orig: C - - - - - 0x00AC16 02:AC06: 90 0D     BCC bra_AC15_RTS
    ...
    BCS     bra_AC15_RTS             ; BCC  ; orig: C - - - - - 0x00AC1D 02:AC0D: 90 06     BCC bra_AC15_RTS
...
bra_AE17_loop:  ; orig: bra_AE17_loop:
    ...
    BCS     bra_AE36             ; BCC  ; orig: C - - - - - 0x00AE38 02:AE28: 90 0C     BCC bra_AE36
...
bra_AE63_loop:  ; orig: bra_AE63_loop:
    ...
    BCC     bra_AEE2             ; BCS  ; orig: C - - - - - 0x00AE7E 02:AE6E: B0 72     BCS bra_AEE2
...
; if 1st quest
    ...
    BCC     bra_AEDF             ; BCS  ; orig: C - - - - - 0x00AE89 02:AE79: B0 64     BCS bra_AEDF
...
; if 2nd quest
    ...
    BCS     bra_AE8A             ; BCC  ; orig: C - - - - - 0x00AE94 02:AE84: 90 04     BCC bra_AE8A
    CMPI.B  #$10,D2  ; orig: C - - - - - 0x00AE96 02:AE86: C0 10     CPY #$10
    BCS     bra_AEDF             ; BCC  ; orig: C - - - - - 0x00AE98 02:AE88: 90 55     BCC bra_AEDF
...
bra_AE9F_loop:  ; orig: bra_AE9F_loop:
    ...
    BCS     bra_AEDF             ; BCC  ; orig: C - - - - - 0x00AEBF 02:AEAF: 90 2E     BCC bra_AEDF
...
bra_AEBD_loop:  ; orig: bra_AEBD_loop:
    ...
    BCS     bra_AEBD_loop             ; BCC  ; orig: C - - - - - 0x00AED7 02:AEC7: 90 F4     BCC bra_AEBD_loop
...
bra_AEF2:  ; orig: bra_AEF2:
    ...
    BCS     bra_AF05             ; BCC  ; orig: C - - - - - 0x00AF12 02:AF02: 90 01     BCC bra_AF05
...
bra_AF43:  ; orig: bra_AF43:
    ...
    BCS     bra_AF50             ; BCC  ; orig: C - - - - - 0x00AF5C 02:AF4C: 90 02     BCC bra_AF50
