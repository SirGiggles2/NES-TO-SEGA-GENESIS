...
; AUTO-RESTORED TITLE DATA END
    DC.B $9A,$92  ; data (was .WORD _off002_929A_00_all_of_treasures)
    DC.B $BC,$92  ; data (was .WORD _off002_92BC_01_heart___container)
    DC.B $D1,$92  ; data (was .WORD _off002_92D1_02_heart)
    DC.B $D8,$92  ; data (was .WORD _off002_92D8_03_fairy___clock)
    DC.B $EC,$92  ; data (was .WORD _off002_92EC_04_rupy___5_rupies)
    DC.B $7F,$94  ; data (was .WORD _off002_947F_05_life_potion___2nd_potion)
    DC.B $99,$94  ; data (was .WORD _off002_9499_06_letter___food)
    DC.B $01,$93  ; data (was .WORD _off002_9301_07_sword___white)
    DC.B $15,$93  ; data (was .WORD _off002_9315_08_sword)
    DC.B $1C,$93  ; data (was .WORD _off002_931C_09_magical___magical)
    DC.B $32,$93  ; data (was .WORD _off002_9332_0A_sword_shield)
    DC.B $47,$93  ; data (was .WORD _off002_9347_0B_boomerang___magical)
    DC.B $5E,$93  ; data (was .WORD _off002_935E_0C_boomerang)
    DC.B $69,$93  ; data (was .WORD _off002_9369_0D_bomb___bow)
    DC.B $7C,$93  ; data (was .WORD _off002_937C_0E_arrow___silver)
    DC.B $91,$93  ; data (was .WORD _off002_9391_0F_arrow)
    DC.B $98,$93  ; data (was .WORD _off002_9398_10_blue___red)
    DC.B $AB,$93  ; data (was .WORD _off002_93AB_11_candle___candle)
    DC.B $C1,$93  ; data (was .WORD _off002_93C1_12_blue___red)
    DC.B $D4,$93  ; data (was .WORD _off002_93D4_13_ring___ring)
    DC.B $E8,$93  ; data (was .WORD _off002_93E8_14_power___recorder)
    DC.B $FE,$93  ; data (was .WORD _off002_93FE_15_bracelet)
    DC.B $08,$94  ; data (was .WORD _off002_9408_16_raft___stepladder)
    DC.B $1F,$94  ; data (was .WORD _off002_941F_17_magical___book_of)
    DC.B $35,$94  ; data (was .WORD _off002_9435_18_rod___magic)
    DC.B $48,$94  ; data (was .WORD _off002_9448_19_key___magical)
    DC.B $5C,$94  ; data (was .WORD _off002_945C_1A_key)
    DC.B $61,$94  ; data (was .WORD _off002_9461_1B_map___compass)
    DC.B $75,$94  ; data (was .WORD _off002_9475_1C_triforce)
...
; * 04
    ...
    MOVE.B  D1,ram_0000_t18_palette_data+1
    ADD.B  #$69,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x009B9E 02:9B8E: 69 69     ADC #$69
    ...
    ADD.B  #$99,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x009BA4 02:9B94: 69 99     ADC #$99
    MOVE.B  D0,ram_0000_t18_palette_data+1  ; orig: C - - - - - 0x009BA6 02:9B96: 85 01     STA ram_0000_t18_pal
    MOVE.B  #$3F,D0  ; orig: C - - - - - 0x009BA8 02:9B98: A9 3F     LDA #$3F
    MOVE.B  D0,ram_0302_ppu_buffer  ; orig: C - - - - - 0x009BAA 02:9B9A: 8D 02 03  STA ram_0302_ppu_buf
    MOVE.B  #$00,D0  ; orig: C - - - - - 0x009BAD 02:9B9D: A9 00     LDA #$00
...
b02_bra_9BAE_loop:  ; orig: b02_bra_9BAE_loop:
    MOVEA.L #ram_0000_t18_palette_data,A0
    MOVE.W  (A0),D5
    ROL.W   #8,D5
    MOVEA.W D5,A1
...
; bzk optimize, BCC + INC 000E
    ...
    ADD.B  #$00,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x00A368 02:A358: 69 00     ADC #$00
...
sub_A42B_add_to_00CE:  ; orig: sub_A42B_add_to_00CE:
    ...
    ADD.B  #$00,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x00A442 02:A432: 69 00     ADC #$00
...
b02_bra_ABE2:  ; orig: b02_bra_ABE2:
    ...
    ADD.B  #$00,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x00ABF4 02:ABE4: 69 00     ADC #$00
...
b02_bra_AF30:  ; orig: b02_bra_AF30:
    ...
    ADD.B  #$C0,D0       ; ADC imm (uses X flag for carry)  ; orig: C - - - - - 0x00AF49 02:AF39: 69 C0     ADC #$C0
