...
bS2_bra_6EBA:  ; orig: bS2_bra_6EBA:
    ...
    BCC     bS2_bra_6ED5             ; BCC  ; orig: - D 1 - I - 0x00673E 01:6EBE: 90 15     BCC bS2_bra_6ED5
...
bS2_bra_6FDC:  ; orig: bS2_bra_6FDC:
    ...
    ADD.B  #$00,D0       ; ADC imm (uses X flag for carry)  ; orig: - D 1 - I - 0x006861 01:6FE1: 69 00     ADC #$00
    MOVEA.L #ram_0394_enemy,A0
    MOVE.B  D0,(A0,D1.L)
...
bS2_bra_7003:  ; orig: bS2_bra_7003:
    ...
    SUB.B  #$00,D0       ; SBC imm  ; orig: - D 1 - I - 0x006888 01:7008: E9 00     SBC #$00
    MOVEA.L #ram_0394_enemy,A0
    MOVE.B  D0,(A0,D1.L)
...
; / 04
    ...
    ADD.B  #$17,D0       ; ADC imm (uses X flag for carry)  ; orig: - D 1 - I - 0x006A72 01:71F2: 69 17     ADC #$17
