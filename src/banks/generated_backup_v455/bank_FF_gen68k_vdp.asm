...
; triggers when bomb is exploding near breakable wall
    ...
    BCC     bra_E8AC             ; BCC  ; orig: C - - - - - 0x01E8A7 07:E897: 90 13     BCC bra_E8AC
    CMPI.B  #$F3,D0  ; orig: C - - - - - 0x01E8A9 07:E899: C9 F3     CMP #$F3
    BCS     bra_E8AC             ; BCS  ; orig: C - - - - - 0x01E8AB 07:E89B: B0 0F     BCS bra_E8AC
...
; con_script_screen_trans_in_prog
    ...
    BEQ     bra_E9C2_RTS             ; BEQ  ; orig: C - - - - - 0x01E9BB 07:E9AB: F0 15     BEQ bra_E9C2_RTS

; if transition is ON
    MOVE.B  ram_prev_screen_transition_flag,D0  ; orig: C - - - - - 0x01E9BD 07:E9AD: A5 F3     LDA ram_prev_screen_
    BNE     bra_E9C2_RTS             ; BNE  ; orig: C - - - - - 0x01E9BF 07:E9AF: D0 11     BNE bra_E9C2_RTS
