...
TRACE_BANK_RAW  EQU $FFF040
TRACE_BANK_POST EQU $FFF042
TRACE_SCRIPT_RAW EQU $FFF044
TRACE_DISP_INDEX EQU $FFF046
TRACE_DISP_BASE EQU $FFF048
TRACE_DISP_TARGET EQU $FFF04C
TRACE_DISP_STACK EQU $FFF050
