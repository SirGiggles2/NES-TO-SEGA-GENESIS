...
; AUTO-TRANSLATED from NES 6502 â†’ Sega Genesis 68000
; â”€â”€ VDP Layer included via vdp_layer.asm â”€â”€
...
loc_0x008022_fill_ppu_with_tiles_1:  ; orig: loc_0x008022_fill_ppu_with_tiles_1:
    ...
    BSR     PPU_READ_2002  ; read VDP status â†’ D0  ; was: C - - - - - 0x008025 02:8015: AD 02 20  LDA $2002
