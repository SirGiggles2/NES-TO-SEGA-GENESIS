...
$SCRIPT     = "$PROJECT\diag\scripts\zelda_register_probe.lua"
$LOCK_PATH  = "$PROJECT\diag\scripts\zelda_register_probe.lock"
$REPORTS    = "$PROJECT\diag\reports"

$BaseName   = [System.IO.Path]::GetFileNameWithoutExtension($Rom)
$RomPath    = "$BUILD_DIR\$BaseName.md"
$OutputPath = "$REPORTS\register_probe_$BaseName.txt"
